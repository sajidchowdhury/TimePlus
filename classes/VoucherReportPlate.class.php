            ...
            <div class="card card-primary">
              ...
              <form role="form" action="" method="get">
                ...
                <div class="row">
                          ...
                          <option data-custom="Need-Two-Date" value="Ledger-Wise" > Ledger Wise  </option>
                          <option data-custom="Need-Two-Date" value="Account-Wise" > Account Wise  </option>
                      ...
                      <input type="hidden" id="report_name" name="report_name" value="Voucher Wise Report">
