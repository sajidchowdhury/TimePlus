            ...
            <div class="card card-primary">
              ...
              <form role="form" action="" method="get">
                ...
                <div class="row">
                          ...
                          <option data-custom="Need-Single-Date" value="Daily-Cash" > Daily Cash  </option>
                          <option data-custom="Need-Single-Date" value="Summery" > Summery  </option>
                      ...
                      <input type="hidden" id="report_name" name="report_name" value="Cashbook Report">
