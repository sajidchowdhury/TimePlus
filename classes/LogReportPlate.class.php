            ...
            <div class="card card-primary">
              ...
              <form role="form" action="" method="get">
                ...
                <div class="row">
                          ...
                          <option data-custom="Need-Two-Date" value="All" > All </option>
                          <option data-custom="Need-Two-Date" value="User-Wise" > User Wise  </option>
                      ...
                      <input type="hidden" id="report_name" name="report_name" value="Log Report">
