...
class ReportProductMovementPlate {
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Report Type</label>
                          ...
                          <option value="">-- Select -- </option>
                           ...
                           <option data-custom="Need-Two-Date" value="Product-Wise" > Product Wise  </option>
                      ...
                      <input type="hidden" id="report_name" name="report_name" value="Product Movement Report">
