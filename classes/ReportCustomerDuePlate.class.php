            ...
            <div class="card card-primary">
              ...
              <form role="form" action="" method="get">
                ...
                <div class="row">
                          ...
                          <option data-custom="Need-Two-Date" value="Date-Wise-Collection" >    Collection  </option>
                          <option data-custom="Need-Single-Date" value="Due-Summery" > Current Due  </option>
                          <option data-custom="Need-Two-Date" value="Customer-Wise" >  Customer Wise Due </option>
                      ...
                      <input type="hidden" id="report_name" name="report_name" value="Customer Due Report">
