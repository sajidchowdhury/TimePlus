...
$siteStructure = new SiteStructure($scripts,'sales_return_report','');
$Form = new ReportSalesReturnPlate('New','sales_return_report.php');
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Return Report</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
